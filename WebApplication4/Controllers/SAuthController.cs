...
namespace YourNamespace.Controllers
{
    public class SAuthController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Login([Bind("Id,Name,LastName,UserEmail,Password")] SAuthViewModel suser)
        {
        ...
        public async Task<IActionResult> Register1([Bind("Id,Name,LastName,UserEmail,Password")] SAuthViewModel sProduct)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.Message = $"Welcome {sProduct.Name} ! Your username is {sProduct.UserEmail}";
